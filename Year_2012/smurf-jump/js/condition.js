...
function init() {
	...
	function gameOver() {
		...
		if(player.y > height/2 && flag === 0) {
			...
			tweet.href='http://twitter.com/share?url=http://bit.ly/YoDzRw&text=I just scored ' +score+ ' points in SmurfJump game!&count=horiztonal&via=jayvisavadia&related=jayvisavadia';
		
			var facebook = document.getElementById("fbBtn");
			facebook.href='http://facebook.com/sharer.php?s=100&p[url]=http://cssdeck.com/labs/html5-doodle-jump/8&p[title]=I just scored ' +score+ ' points in  SmurfJump game!&p[summary]=Can you beat me in this awesome recreation of SmurfJump?';
